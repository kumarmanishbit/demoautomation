...
public class ProviderParticipationDao {
	...
	public long findProviderParticipation(long providerLocationId, long providerNetworkId, long providerId) {
		...
		String sql = "select id from provider_participations where provider_network_id=" + providerNetworkId
				+ " and  provider_id= " + providerId + " and provider_location_id =" + providerLocationId;
